...
export default function HomeCounters() {
  ...
  const c = config.homePageConfig.counter;

  return (
    <section className="counter-area counter-area-v1 pt-32 pb-16 md:pt-48 md:pb-24">
      <div className="container mx-auto max-w-6xl px-4">
        <div className="mx-auto mb-14 max-w-xl text-center">
          <span
            ...
            {...cp('homePageConfig.counter.subTitle')}
          >
            {t(c.subTitle)}
          </span>
          <h2
            className="text-3xl font-bold text-slate-900 md:text-4xl"
            {...cp('homePageConfig.counter.title')}
          >
            {t(c.title)}
          </h2>
          <p
            className="mt-4 text-slate-600"
            {...cp('homePageConfig.counter.description')}
          >
            {t(c.description)}
          </p>
        </div>
            ...
            >
              ...
              <div className="text">
                ...
                <p
                  ...
                  {...cp(`homePageConfig.counter.items.${i}.label`)}
                >
                  {t(item.label)}
                </p>
              </div>
